#' @title Study area mask for the `landslides` dataset
#' @description Study area polygon for the `landslides` dataset
#' @format An `sf` polygon object representing the outlines of
