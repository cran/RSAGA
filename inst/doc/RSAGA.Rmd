...
The object `env` may now be used to direct RSAGA functions to use this specific version of SAGA. Version `6.2.0` will be used for this tutorial by specifying `env = env` in functions that use this SAGA environment.
